...
Il y avait eu une période de plusieurs années sans financement et Gandi avait donc décidé d'offrir à 100%, mais c'est revenu à 50% depuis juin 2021.
...
Situohen : OK pour commencer sans investir d'argent et voir si ça prend, puis orienter un petit budget pour les micros car c'est le point le plus important. Si besoin de plus de financement ok pour un financement participatif pour ne pas augmenter les cotisations de l'asso.
...
Actuellement ~25 abonnés sur la chaîne twitch sans ne jamais avoir rien streamé. En en parlant dans différents réseaux ayant un pied dans ce milieu (pogsciences, deuchnord, chabrette, melcore) il y aurait moyen de toucher du monde.
...
Situphen a rédigé un message où il essayer d'inscrire les règles pour décider de comment sont déterminés les accès.
...
Une liste serait maintenue pour savoir qui a accès à quoi : [https://zestedesavoir.com/forums/sujet/14012/qui-a-acces-a-quoi/](https://zestedesavoir.com/forums/sujet/14012/qui-a-acces-a-quoi/)



vhf (inactif) a toujours accès au serveur de prod via l'utilisateur Munin car c'est on utilise son serveur Munin pour surveiller l'état du serveur
