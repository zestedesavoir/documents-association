# Réunion du lundi 18 aout 2025
Début de la réunion à 21h05

Présents (CA) :
	* Gabbro 
	* Rockaround (parti à 21h15)
	* Melcore
...
Priorité (à établir pour chaque sujet ensemble)
  ...
  ⏬️ Pas d'urgence
			...
			Problème de modération : Qqun remonte auprès de Gabbro que la modération a été trop forte sur un sujet. La modération avait été faite par des modérateurs qui font de la modération "temporisation". 
			Pas d'attaque sur une personne. Est-ce qu'il y a une action à lancer là-dessus.
			Pas d'action prévue, mais à surveiller.
			
			Pas de nouvelles de Gandi, Rockaround contact un autre hébergeur d'ici la prochaine réunion.
			...
			* AGO 2025 du 1er mars 
				...
				* Bilan moral à publier @Amaury (toujours vrai en août) (tapez-moi)
				* Rédaction au propre des procès-verbaux @Situphen => délai de 2 semaines à tout le CA pour valider les procès-verbaux
				* Publication sur compte asso @firm1 (bloqué par le bilan moral manquant)
				* Déclaration des nouveaux statuts et des nouveaux membres du CA @Situphen (toujours vrai en juillet)
						* Nouveaux statuts signés, y’a plus qu’à — Amaury (août 2025)

			* État des lieux pour la validation - TEST EN COURS (=> jusqu'à septembre) 
				* Actions
				...
				* Mini debrief en avance : sur neuf nouveaux contenus, Gabbro en a écrit ou relu (seul ou à plusieurs) 8. Risque !
					...
					* La situation s’est un peu améliorée en juillet
				* Les référent·es, en qualité de surveillance / relances en cas de contenu oublié trop longtemps, ça marche bien ! (Et lancement du process de valido externe si personne motivé)
			...
			* Mieux mettre en avant nos contenus existants
				...
				* Action : créer un sujet sur le forum => Amaury
			...
			* Gandi
				...
				* firm1 propose de s’inquiéter en septembre (M moins 2)
				...
				* Des success story chez Scaleway qui concernent des associations : https://www.scaleway.com/fr/blog/comment-infoclimat-architecte/ ou https://www.scaleway.com/fr/temoignages-clients/animath/
...
Action à réaliser
	...
	* ⏳🔼 @Chacun : Relecture et validation des procès-verbaux (délai de 2 semaines à partir de cette réunion donc jusqu'au lundi 4 août)
	...
	* ⏳🔼@Rockaround : Relancer pour voir comment continuer avec Gandi (pas de réponse au premier contact : tenter de recontacter à leur adresse de contact générale ou support client)
	* ⏳⏫️ @Chacun : Vérifier que vos informations pour l'État sont bien à jour (se connecter au compte Google de zestedesavoir@gmail.com) : https://docs.google.com/spreadsheets/d/1EllKN-2fJw_K8ykdg0sbm_2Qg3NQtSc6hmBIx6arQtY/edit?gid=0#gid=0
	...
	* Contenus en validation
		* ❌⏹️ @Quiconque : Que se passe-t-il avec le tutoriel "Rendez votre application Django plus rapide" en attente de validation depuis 2020 ?! Alors qu'il semble prêt ?! -> voir avec artragis (Gabbro s’en charge)
	...
	* Modérateurices sur la page contact
		...
		* ✅ @Quiconque : valider le texte
		* ✅ @Situphen : dupliquer sur la prod
	* ❌⏹️ @Quiconque : considérer les alternatives en terme d’hébergeur
	* ❌⏹️ @Quiconque de l’équipe technique : débloquer les UA IA de recherche instantanée (pas d’entraînement) et laisser reposer le débat pour le reste (manque d’informations et de données pour prendre une décision éclairée) => à discuter prochaine réunion technique

Fin de la réunion à 21h17
